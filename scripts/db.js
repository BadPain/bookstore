...
let allAuthorNames = [];
books.forEach(book => allAuthorNames.push(book.author));
console.log(allAuthorNames);

let allpublishedYearNames = [];
books.forEach(book => allpublishedYearNames.push(book.publishedYear));
console.log(allpublishedYearNames);
